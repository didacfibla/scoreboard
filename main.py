...
boardState = {0: make_row(), 1: make_row(), 2: make_row(), 3: make_row(), 4: make_row(), 5: make_row(),
              6: make_row()}
boardImage = {0: make_row_Image(), 1: make_row_Image(), 2: make_row_Image(), 3: make_row_Image(), 4: make_row_Image(),
              5: make_row_Image(),
              6: make_row_Image()}
...
def checkWinDiagonal(color, coordinates):
    connectFours = 0
    winningDiagonals = {'a6': [(0, 5), (1, 4), (2, 3), (3, 2)], 'a5': [(0, 4), (1, 3), (2, 2), (3, 1)],
                        'a4': [(0, 3), (1, 2), (2, 1), (3, 0)],
                        'b6': [(1, 5), (2, 4), (3, 3), (4, 2)], 'b5': [(1, 4), (2, 3), (3, 2), (4, 1)],
                        'b4': [(1, 3), (2, 2), (3, 1), (4, 0)],
                        'c6': [(2, 5), (3, 4), (4, 3), (5, 2)], 'c5': [(2, 4), (3, 3), (4, 2), (5, 1)],
                        'c4': [(2, 3), (3, 2), (4, 1), (5, 0)],
                        'd6a': [(3, 5), (2, 4), (1, 3), (0, 2)], 'd5a': [(3, 4), (2, 3), (1, 2), (0, 1)],
                        'd4a': [(3, 3), (2, 2), (1, 1), (0, 0)],
                        'd6b': [(3, 5), (4, 4), (5, 3), (6, 2)], 'd5b': [(3, 4), (4, 3), (5, 2), (6, 1)],
                        'd4b': [(3, 3), (4, 2), (5, 1), (6, 0)],
                        'e6': [(4, 5), (3, 4), (2, 3), (1, 2)], 'e5': [(4, 4), (3, 3), (2, 2), (1, 1)],
                        'e4': [(4, 3), (3, 2), (2, 1), (1, 0)],
                        'f6': [(5, 5), (4, 4), (3, 3), (2, 2)], 'f5': [(5, 4), (4, 3), (3, 2), (2, 1)],
                        'f4': [(5, 3), (4, 2), (3, 1), (2, 0)],
                        'g6': [(6, 5), (5, 4), (4, 3), (3, 2)], 'g5': [(6, 4), (5, 3), (4, 2), (3, 1)],
                        'g4': [(6, 3), (5, 2), (4, 1), (3, 0)]}
...
def make_move(column, turnCount):
    ...
    for r in range(1, 8):
        ...
        if boardState[column][rIndex] == '':
            ...
            boardImage[column][rIndex] = Label(gameFrame, image=colorScheme[color]).grid(row=gridRowIndex,
                                                                                         column=column)
            break
...
for r in range(7):
    Button(gameFrame, text="Drop", bg='light blue', activebackground='yellow',
           command=lambda x=r: make_move(x, turnCount)).grid(row=10, column=r)
